...
var filename = `${baserl}/assets/img/wordclouds/${filters.region}__${filters.subset}__${filters.pos_tag}__${filters.ngram}.jpg`

function on_wordcloud_filter_change(new_filter) {
    filters[new_filter.key] = new_filter.value
    filename = `${baserl}/assets/img/wordclouds/${filters.region}__${filters.subset}__${filters.pos_tag}__${filters.ngram}.jpg`
